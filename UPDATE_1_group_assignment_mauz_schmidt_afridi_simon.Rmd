...
We observe $(Y_i, D_i, T_i, X_i)$ where $D_i \in \{0,1\}$ is the treatment variable and $T_i \in \{0,1\}$ is the time variable. The parameter of interest is the ATT (average treatment effect on the treated): $$\theta_0 = E[(Y(1) - Y(0)| D=1, \, T=1 ]$$ identified in Cross Sectional DiD under parallel trend and standard overlap assumption.
