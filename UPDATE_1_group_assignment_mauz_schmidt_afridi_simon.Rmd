...
E[\psi_a \theta + \theta_b] = 0 \Rightarrow \hat{\theta} = - \frac{E_i[\psi_b]}{E_i[\psi_a]}
$$ Afterward we constructed the influence function $$ IF_i = \frac{-1}{E[\psi_a]} \cdot \psi$$ and used it to get clustered standard errors.
