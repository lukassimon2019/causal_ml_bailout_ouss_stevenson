...
doubleML_did_cs_gate <- function(data, y_var, d_var, t_var, x_vars, methods, cf = 5,
  ...
  Y  <- data[[y_var]]
  D  <- as.numeric(data[[d_var]]) # turned into numeric later for estimation of Y.hat.d and the score computation (needs to be factor for nuisance parameter estimation of D.hat)
